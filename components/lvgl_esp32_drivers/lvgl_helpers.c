...
/* Display controller initialization */
    ...
    ESP_LOGI(TAG, "SPI_BUS_MAX_TRANSFER_SZ = %d", SPI_BUS_MAX_TRANSFER_SZ);

    lvgl_spi_driver_init(TFT_SPI_HOST,
        DISP_SPI_MISO, DISP_SPI_MOSI, DISP_SPI_CLK,
        SPI_BUS_MAX_TRANSFER_SZ, SPI_DMA_CH_AUTO,   // 0 => no DMA
        DISP_SPI_IO2, DISP_SPI_IO3);

    ESP_LOGI(TAG, "SPI dirver initialized");
    ...
    int quadwp_pin, int quadhd_pin)
{
    ...
    ESP_LOGI(TAG, "Using DMA channel: %d", dma_channel);
